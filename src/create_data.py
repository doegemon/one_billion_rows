...
def build_test_data(weather_station_names: list, num_rows_to_create: int, file_path: str) -> None:
  """
  ...
  batch_size: int = 10_000 # instead of writing line by line to file, process a batch of stations
...
def main() -> None:
  ...
  build_test_data(weather_station_names, num_rows_to_create, file_path=final_file_path)
